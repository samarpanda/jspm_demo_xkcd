...
System.register("lib/xkcd-item", [], function($__export) {
  "use strict";
  var __moduleName = "lib/xkcd-item";
  return {
    setters: [],
    execute: function() {
      $__export('default', (function(item) {
        return item;
      }));
    }
  };
...
System.register("lib/xkcd-view", [], function($__export) {
  "use strict";
  var __moduleName = "lib/xkcd-view";
  return {
    setters: [],
    execute: function() {
      $__export('default', (function(item) {
...
System.register("lib/xkcd-api", ["npm:jsonp@0.1.0"], function($__export) {
  "use strict";
  var __moduleName = "lib/xkcd-api";
  var jsonp,
      XkcdApi;
  return {
    setters: [function(m) {
    ...
    execute: function() {
      XkcdApi = (function() {
        var XkcdApi = function XkcdApi() {
          this.xkcdURL = "https://morning-river-6203.herokuapp.com/xkcd_jsonp/";
        };
        return ($traceurRuntime.createClass)(XkcdApi, {load: function() {
            var $__0 = this;
            return new Promise((function(resolve, reject) {
              jsonp($__0.xkcdURL, {param: 'callback'}, (function(err, data) {
                err ? reject(err) : resolve(data);
              }));
            }));
          }}, {});
      }());
      $__export('default', new XkcdApi);
    }
  };
});
...
System.register("lib/main", ["lib/xkcd-api", "lib/xkcd-item", "lib/xkcd-view"], function($__export) {
  "use strict";
  ...
  return {
    ...
    execute: function() {
      XkcdApi.load().then(XkcdItem, function(err) {
...
//# sourceMappingURL=xkcd_build.js.map